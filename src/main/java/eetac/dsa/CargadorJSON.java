...
import eetac.dsa.Objetos.OrdenParametro;
...
public class CargadorJSON {
    ...
    public static Escenario jsonAEscenario(String json) throws CargarDeJsonException {
        ...
        try {
            for (int i = 0; i < celdas.length(); i++) {
                ...
                Class clase = Class.forName("eetac.dsa.Celdas." + obj.getString("tipo"));
                int x = obj.getInt("x");
                int y = obj.getInt("y");
    ...
    public static Monstruo jsonAMonstruo(String json) throws CargarDeJsonException {
        try {
            ...
            Class monstruoClass = Class.forName("eetac.dsa.Monstruos." + monstruoJson.getString("tipo"));
    ...
    public static Objeto jsonAObjeto(String json) throws CargarDeJsonException {
        try {
            ...
            Class objetoClass = Class.forName("eetac.dsa.Objetos." + objetoJson.getString("tipo"));
